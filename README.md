...
Physics-guided LightGBM flood predictor for Bangladesh. 0.98+ AUC using river/coast distance, elevation-aware spatial risk, monsoon + climate-trend seasonal_risk &amp; monotonic constraints. Full notebook, data &amp; model. Ready for early-warning systems. #flood #bangladesh #physics-ml
